...
[_BASE] = LAYOUT_preonic_grid(
  ...
  KC_ESC,  LCLT_T(KC_A), LALT_T(KC_S), LGUI_T(KC_D), LSFT_T(KC_F), KC_G,   KC_H,   LSFT_T(KC_J), LGUI_T(KC_K), LALT_T(KC_L),  KCTL_T(KC_SCLN),KC_ENT,
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_LSFT,    KC_NUBS,    S(KC_QUOT), KC_QUOT,    S(KC_2),    _______,    _______,    KC_MINS,    KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
